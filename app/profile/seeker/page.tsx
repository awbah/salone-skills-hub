...
export default function SeekerProfilePage() {
  ...
  const [activeTab, setActiveTab] = useState<"basic" | "profile" | "password">("basic");
  ...
  useEffect(() => {
    async function fetchProfile() {
      try {
        ...
        if (data.profile) {
          setProfileInfo({
            pathway: data.profile.pathway || "STUDENT",
  ...
  const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const data = await response.json();
      // Store fileId - you'll need to update user profile with this
  ...
  const handleProfileInfoSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/profile/seeker", {
        ...
        body: JSON.stringify({
          ...profileInfo,
          yearsExperience: profileInfo.yearsExperience
            ? parseInt(profileInfo.yearsExperience)
            : null,
                  ...
                  {activeTab === "profile" && (
                    <form onSubmit={handleProfileInfoSubmit} className="space-y-6">
                      <div>
                        ...
                        <select
                          value={profileInfo.pathway}
                          onChange={(e) =>
                            setProfileInfo({ ...profileInfo, pathway: e.target.value })
                          }
                          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-sierra-green focus:border-transparent dark:bg-gray-700 dark:text-white"
                          required
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setProfileInfo({ ...profileInfo, profession: e.target.value })
                          }
                          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-sierra-green focus:border-transparent dark:bg-gray-700 dark:text-white"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setProfileInfo({ ...profileInfo, headline: e.target.value })
                          }
                          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-sierra-green focus:border-transparent dark:bg-gray-700 dark:text-white"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setProfileInfo({ ...profileInfo, yearsExperience: e.target.value })
                            }
                            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-sierra-green focus:border-transparent dark:bg-gray-700 dark:text-white"
                          />
                        </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setProfileInfo({ ...profileInfo, availability: e.target.value })
                          }
                          className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-sierra-green focus:border-transparent dark:bg-gray-700 dark:text-white"
                          placeholder="e.g., Full-time, Part-time, Available immediately"
                        />
                      </div>
                      <button
                        type="submit"
