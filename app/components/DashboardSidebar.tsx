...
export default function DashboardSidebar({ role }: DashboardSidebarProps) {
    ...
    switch (role) {
      ...
      case "EMPLOYER":
        return [
          ...
          },
          {
            ...
            href: "/dashboard/employer/my-job-postings",
            icon: (
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
      ...
      case "ADMIN":
        return [
          ...
          {
            label: "Browse Talent",
            href: "/dashboard/admin/browse-talent",
            icon: (
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
  ...
  // Show full sidebar when: manually expanded (pinned) OR when hovered
  // Collapse to icons when: not pinned AND not hovered
  const showFullSidebar = isExpanded || isHovered;
  
  // Store sidebar width in CSS variable for main content to use
  useEffect(() => {
  ...
  return (
    <>
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={`
                      ...
                      ${isActive
                        ? "bg-sierra-green text-white dark:bg-sierra-green"
      ...
      <button
        ...
        className="lg:hidden fixed top-20 left-4 z-20 p-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
