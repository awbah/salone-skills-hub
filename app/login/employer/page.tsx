...
export default function EmployerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      window.location.href = data.redirectUrl || "/dashboard/employer";
    } catch (error: any) {
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-20 mt-20">
        <div className="w-full max-w-md">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg text-black focus:ring-2 focus:ring-sierra-blue focus:border-transparent transition-all duration-300 outline-none"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    id="remember"
                    type="checkbox"
                    className="w-4 h-4 text-sierra-blue border-gray-300 rounded focus:ring-sierra-blue"
                  />
                  <label
                    htmlFor="remember"
                ...
                <Link
                  ...
                  className="text-sm text-sierra-blue hover:text-sierra-blue-dark transition-colors duration-300"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/"
              className="text-sierra-green hover:text-sierra-green-dark transition-colors duration-300 inline-flex items-center"
            >
              <svg
