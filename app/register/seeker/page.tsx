...
export default function SeekerRegisterPage() {
  const [formData, setFormData] = useState({
    ...
    confirmPassword: "",
    phone: "",
    pathway: "GRADUATE" as "STUDENT" | "GRADUATE" | "ARTISAN",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/auth/signup/seeker", {
        method: "POST",
        ...
        <div className="w-full max-w-2xl">
          <div className="bg-white rounded-2xl shadow-2xl p-8 animate-fade-in-up">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-sierra-green to-sierra-green-dark rounded-full mb-4 animate-float">
                <svg
              ...
              <p className="text-gray-600">
                Join thousands of job seekers finding opportunities in Sierra
                Leone
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onBlur={handleBlur}
                    className={`w-full px-4 py-3 border rounded-lg text-black focus:ring-2 focus:ring-sierra-green focus:border-transparent transition-all duration-300 outline-none ${
                ...
                <div className="relative">
                  ...
                  {checkingAvailability.email && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2">
                      <svg
                        className="animate-spin h-5 w-5 text-sierra-green"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg text-black focus:ring-2 focus:ring-sierra-green focus:border-transparent transition-all duration-300 outline-none"
                >
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      className={`w-full px-4 py-3 pr-12 border rounded-lg text-black focus:ring-2 focus:ring-sierra-green focus:border-transparent transition-all duration-300 outline-none ${
              ...
              <div className="flex items-start">
                <input
                  ...
                  type="checkbox"
                  required
                  className="mt-1 w-4 h-4 text-sierra-green border-gray-300 rounded focus:ring-sierra-green"
                />
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-sierra-green to-sierra-green-dark text-white py-3 rounded-lg font-semibold hover:shadow-lg transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
